;;; doom-anne-pastel-theme.el --- a candy colored theme by sailorhg -*- lexical-binding: t; no-byte-compile: t; -*-
;;
...
(defgroup doom-anne-pastel-theme nil
  "Options for doom-themes."
  :group 'doom-themes)

(defcustom doom-anne-pastel-brighter-modeline nil
  "If non-nil, more vivid colors will be used to style the mode-line."
  :group 'doom-anne-pastel-theme
  :type 'boolean)

(defcustom doom-anne-pastel-brighter-comments nil
  "If non-nil, comments will be highlighted in more vivid colors."
  :group 'doom-anne-pastel-theme
  :type 'boolean)

(defcustom doom-anne-pastel-comment-bg doom-anne-pastel-brighter-comments
  "If non-nil, comments will have a subtle, darker background. Enhancing their
legibility."
  :group 'doom-anne-pastel-theme
  :type 'boolean)

(defcustom doom-anne-pastel-padded-modeline doom-themes-padded-modeline
...
(def-doom-theme doom-anne-pastel
  ...
  ((bg         '("#6867AC" nil       nil           ))
   ...
   (-modeline-bright doom-anne-pastel-brighter-modeline)
   (-modeline-pad
    (when doom-anne-pastel-padded-modeline
      (if (integerp doom-anne-pastel-padded-modeline) doom-anne-pastel-padded-modeline 4)))
  ...
  (((font-lock-comment-face &override)
    :background (if doom-anne-pastel-comment-bg (doom-lighten bg 0.05) 'unspecified))
...
;;; doom-anne-pastel-theme.el ends here
